...
public class AddressbookUI extends UI {
	...
	private Button showCustomTableButton = new Button("Show custom table");
	...
	private void initLayout() {
		...
		bottomLeftLayout.addComponent(showCustomTableButton);
	...
	private void initAddRemoveButtons() {
		...
		showCustomTableButton.addClickListener(new ClickListener() {
			@Override
			public void buttonClick(ClickEvent event) {
	...
	public void initSpringBeans() {
		...
		customerRepository = (CustomerRepository) sch.getBean("customerRepository");
	}
